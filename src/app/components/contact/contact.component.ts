...
export class ContactComponent {
  constructor(private _ContactService:ContactService , public _LangService:LangService){
  ...
  contactForm:FormGroup = new FormGroup({
    ...
    inquery:new FormControl(null , Validators.required),
    contact:new FormControl('mobil' , Validators.required)
  })
optionsValue(e:any)
{
